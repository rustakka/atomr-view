use atomr_view_core::bridge::{UiBridgeActor, BackendCommand, BackendEvent, UiBridgeMessage};
use atomr_view_core::scene::{SceneDescription, SceneNode, SceneKey, NodeKind, PropertyMap};
...
async fn test_bridge_conflation() {
    ...
    let bridge_actor = system.actor_of(Props::create(move || {
